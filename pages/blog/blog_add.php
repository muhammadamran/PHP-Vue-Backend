  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card ">
        ...
        <div class="card-body ">
            <form action="pages/blog/blog_proses.php?aksi=insert" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="inputText3" name="sinopsis" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label for="content" class="col-form-label">Content</label>
                    <textarea name="content" rows="4" class="ckeditor form-control"></textarea>
                </div>
                <div class="form-group">
